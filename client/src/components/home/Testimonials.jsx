    ...
    <>
        <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-10'>
            <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-4 py-1">
                <BookUserIcon className="size-4.5 stroke-green-600" width={14}></BookUserIcon>
                <span>Testimonials</span>
            </div>
            <Title title="Don't Just Take our Words" description="Here what our users say about us. We're always looking for ways to improve. If you had a positive experience with us, leave a review."></Title>
